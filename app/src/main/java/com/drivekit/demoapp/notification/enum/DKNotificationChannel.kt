...
internal enum class DKNotificationChannel {
    ...
    fun getSharedPreferencesKey() = when (this) {
        ...
        TRIP_CANCELED -> "drivekit_channel_trip_cancelled_pref"
    ...
    fun getChannelId() = when (this) {
        ...
        TRIP_CANCELED -> "drivekit_demo_trip_cancelled_channel"
    ...
    fun getChannelNameResId() = when (this) {
        ...
        TRIP_CANCELED -> R.string.notification_trip_cancelled_title
    ...
    fun getDescriptionResId() = when (this) {
        ...
        TRIP_CANCELED -> R.string.notification_trip_cancelled_description
