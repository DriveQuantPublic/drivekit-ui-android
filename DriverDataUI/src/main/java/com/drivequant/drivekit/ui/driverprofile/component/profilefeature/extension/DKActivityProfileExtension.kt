...
private fun DKActivityProfile.getDescription(activeWeekPercentage: Int): DriverProfileFeatureDescription = when (activeWeekPercentage) {
    ...
    in 58..71 -> DriverProfileFeatureDescription.PluralDescription(R.plurals.dk_driverdata_profile_activity_main_text, 2, "2", "3")
    in 72..78 -> DriverProfileFeatureDescription.PluralDescription(R.plurals.dk_driverdata_profile_activity_main_text, 3, "3", "4")
    in 79..82 -> DriverProfileFeatureDescription.PluralDescription(R.plurals.dk_driverdata_profile_activity_main_text, 4, "4", "5")
    in 83..89 -> DriverProfileFeatureDescription.PluralDescription(R.plurals.dk_driverdata_profile_activity_main_text, 5, "5", "6")
